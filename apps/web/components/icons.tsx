...
export function ClipboardHeartIcon({ className, ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      ...
      <path d="M9 2h6v4H9z" />
      <path d="M12 18s-3-1.8-3-4a1.9 1.9 0 0 1 3-1.55A1.9 1.9 0 0 1 15 14c0 2.2-3 4-3 4Z" />
    </svg>
  );
}

export function DocumentUserIcon({ className, ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function RefreshCcwIcon({ className, ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
